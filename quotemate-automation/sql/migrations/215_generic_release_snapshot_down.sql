-- Restore205's function only. Keep all quote approval stamps, outbox evidence,
-- delivery triggers and207 pricing versions. This removes the strict snapshot
-- guard; coordinate backend rollback rather than treating this as a data reset.
